...
<body>
    <div class="container">
        <div class="header">KWITANSI PEMBAYARAN SEKOLAH</div>
        ...
        <table>
            ...
            <tr>
                ...
                <td><?php echo $nomor_kwitansi,$yr; echo $sis->id_bayarBebas;?></td>
            </tr>
            <tr> 
            ...
            <tr>
                <th class="label">Nama Pembayaran</th>
                <td><?php echo $sis->nama_pembayaran?></td>
            </tr>
            <tr>
                <th class="label">Total Pembayaran</th>
                <td class="total">Rp. <?php echo number_format($sis->jumlah_bayar,0,',','.')?></td>
            </tr>
            <?php endforeach ?>
        </table>
