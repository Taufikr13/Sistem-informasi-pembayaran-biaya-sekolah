...
<div class="container-fluid">
    ...
    <div class="card" style="width:60%;">
        ...
        <?php foreach($siswa as $sis){ ?>
            <form action="<?php echo base_url('admin/dataSiswa/updateDataAksi') ?>" method="post" enctype="multipart/form-data">
                ...
                <div class="form-group">
                    ...
                    <input type="text" name="nisn" class="form-control" value="<?= $sis->nisn?>">
                    <?php echo form_error('nisn')?>
                </div>
                <div class="form-group">
                    <label for="">Kelas</label>
                    <select name="id_kelas" id="" class="form-control">
                        <option value="<?php echo $sis->id_kelas; ?>"><?php echo $sis->kelas; ?></option>
                        <?php
                ...
                <div class="form-group">
                    ...
                    <select name="id_jurusan" id="" class="form-control">
                        <option value="<?php echo $sis->id_jurusan ?>"><?php echo $sis->jurusan ?>  </option>
                        <?php
                ...
                <div class="form-group">
                    ...
                    <input type="text" name="no_hp" class="form-control" value="<?= $sis->no_hp?>">
                </div>
                <div class="form-group">
                    <label for="">Jenis SPP</label>
                    <select name="id_spp" id="" class="form-control">
                        <option value="<?php echo $sis->id_spp ?>"><?php echo $sis->tahunMulai ?>/<?php echo $sis->tahunSelesai ?> Rp. <?php echo number_format($sis->nominal,0,',','.')?> </option>
                        <?php
                        foreach($spp as $sp):
