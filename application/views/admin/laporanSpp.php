        ...
        ?>
            ...
            <?php if(count($siswa)>0){?>
                ...
                <div class="dropdown-menu" aria-labelledby="dropdownMenuLink">
                    <a class="dropdown-item" href="<?php echo base_url('admin/pembayaranSiswa/cetakLaporan?tanggalAwal='.$tanggalAwal),'&tanggalAkhir='.$tanggalAkhir?>"><i class="fas fa-print"> Print</i></a>
                    <a class="dropdown-item" href="<?php echo base_url('admin/pembayaranSiswa/cetakExcel?tanggalAwal='.$tanggalAwal),'&tanggalAkhir='.$tanggalAkhir?>"><i class="fas fa-file"></i> Excel</a>
  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <div class="modal-body">
        Silahkan Filter terlebih dahulu <b>Tanggal Awal</b> dan <b>Tanggal Akhir</b>
      </div>
